...
% This function checks whether a given transition is enabled or not.
% meaning, all the input places of the given transition has enough tokens.
%
% Inputs:
%       t - transition
% Outputs: enabled (0 or 1)
